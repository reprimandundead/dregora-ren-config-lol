...
import mods.notreepunching.Knife;

print("Script starting!");

mods.notreepunching.Knife.add(<minecraft:book>,<minecraft:paper>*2);
...
recipes.addShaped("lolallahrecipe1",<thaumictinkerer:kami_helm>,
 [[<bountifulbaubles:trinketankhcharm>,<divinerpg:call_of_the_watcher>,<variedcommodities:ancient_coin>],
  [<thaumcraft:fabric>,<thaumictinkerer:ichor_helm>,<forgottenitems:water_gem>],
  [<xat:dragon_gem>,<bountifulbaubles:trinketobsidianskull>,<xat:dragon_ring>]]);

recipes.addShaped("lolallahrecipe2",<thaumictinkerer:kami_chest>,
 [[<thaumcraft:fabric>,<twilightforest:knightmetal_chestplate>,<minecraft:nether_star>],
  [<divinerpg:halite_blade>,<thaumictinkerer:ichor_chest>,<divinerpg:bluefire_stone>],
  [<iceandfire:lightning_dragon_heart>,<variedcommodities:artifact>,<bountifulbaubles:trinketankhcharm>]]);

recipes.addShaped("lolallahrecipe3",<thaumictinkerer:kami_legs>,
 [[<divinerpg:fury_fire>,<twilightforest:fiery_ingot>,<bountifulbaubles:trinketankhcharm>],
  [<forgottenitems:heat_gem>,<thaumictinkerer:ichor_legs>,<minecraft:nether_star>],
  [<divinerpg:massivence>,<iceandfire:sapphire_gem>,<variedcommodities:orb:1>]]);

recipes.addShaped("lolallahrecipe4",<thaumictinkerer:kami_boots>,
 [[<minecraft:nether_star>,<thaumictinkerer:sky_pearl>,<xat:greater_inertia_stone>],
  [<minecraft:elytra>,<thaumictinkerer:ichor_boots>,<xat:sea_stone>],
  [<bountifulbaubles:trinketankhcharm>,<xat:glowing_gem>,<iceandfire:sapphire_gem>]]);

recipes.addShaped("lolallahrecipe5",<thaumictinkerer:ichorium_sword_adv>,
 [[<iceandfire:fire_dragon_blood>,<xat:glowing_ingot>,<iceandfire:fire_dragon_flesh>],
  [<xat:glowing_gem>,<thaumictinkerer:ichorium_sword>,<xat:glowing_powder>],
  [<forgottenitems:shock_gem>,<betternether:black_apple>,<iceandfire:fire_dragon_heart>]]);

recipes.addShaped("lolallahrecipe6",<thaumictinkerer:ichorium_pick_adv>,
 [[<xat:glowing_gem>,<thaumcraft:log_silverwood>,<xat:glowing_gem>],
  [<bountifulbaubles:trinketblackdragonscale>,<thaumictinkerer:ichorium_pick>,<bountifulbaubles:trinketapple>],
  [<divinerpg:skythern_pickaxe>,<forgottenitems:hasty_pickaxe>,<divinerpg:mortum_pickaxe>]]);

recipes.addShaped("lolallahrecipe7",<thaumictinkerer:ichorium_axe_adv>,
 [[<thaumcraft:log_silverwood>,<xat:glowing_gem>,<divinerpg:netherite_ingot>],
  [<divinerpg:skythern_axe>,<thaumictinkerer:ichorium_axe>,<divinerpg:mortum_axe>],
  [<divinerpg:shadow_bar>,<xat:glowing_gem>,<thaumcraft:log_silverwood>]]);

recipes.addShaped("lolallahrecipe8",<thaumictinkerer:ichorium_shovel_adv>,
 [[<divinerpg:corrupted_stone>,<xat:glowing_gem>,<thaumcraft:log_silverwood>],
  [<divinerpg:skythern_shovel>,<thaumictinkerer:ichorium_shovel>,<divinerpg:mortum_shovel>],
  [<thaumcraft:log_silverwood>,<xat:glowing_gem>,<divinerpg:molten_stone>]]);

recipes.addShaped("lolallahrecipe9",<thaumictinkerer:ichor_block>,
 [[<xat:glowing_gem>,<thaumictinkerer:kamiresource:1>,<xat:glowing_ingot>],
  [<minecraft:ender_eye>,<minecraft:nether_star>,<minecraft:diamond>],
  [<minecraft:glowstone>,<thaumictinkerer:kamiresource>,<variedcommodities:coin_stone>]]);

recipes.addShaped("lolallahrecipe10",<locks:master_key>,
 [[<xat:glowing_gem>,<thaumictinkerer:kamiresource:1>,<minecraft:nether_star>],
  [<bountifulbaubles:amuletsinwrath>,<locks:key_blank>,<bountifulbaubles:trinketobsidianskull>],
  [<minecraft:nether_star>,<thaumictinkerer:kamiresource>,<variedcommodities:skull>]]);

recipes.addShaped("lolallahrecipe11",<srparasites:weapon_maul>,
 [[<srparasites:infectious_blade_fragment>,<srparasites:living_core>,<srparasites:infectious_blade_fragment>],
  [<srparasites:vile_shell>,<srparasites:hardened_bone_handle>,<srparasites:vile_shell>],
  [<srparasites:dried_tendons>,<srparasites:hardened_bone_handle>,<srparasites:dried_tendons>]]);
